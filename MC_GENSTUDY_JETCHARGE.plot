# BEGIN PLOT /MC_GENSTUDY_JETCHARGE/JetPt$
Title=Transverse momentum of all Jets
XLabel=$p_T$ [GeV]
...
Title=$\eta$ distribution of Jets
XLabel=$\eta$
YLabel=$\int f(x) dx \equiv 1$ 
LogY=0
LegendYPos=0.95
...
Title=Azimuthal distribution of all Jets
XLabel=$\phi$
YLabel=$\int f(x) dx \equiv 1$ 
LogY=0
LegendYPos=0.95
...
Title=Sub-jet $p_\perp$ Standard Deviation
XLabel=$p_\perp$
YLabel=$\int f(x) dx \equiv 1$ 
LogY=0
LegendYPos=0.95
...
Title= Mass of 3 sub-jet tuples
XLabel=$GeV/c^2$
YLabel=$\int f(x) dx \equiv 1$ 
LogY=0
LegendYPos=0.95
...
# BEGIN PLOT /MC_GENSTUDY_JETCHARGE/JetMassFilt$
...
# BEGIN PLOT /MC_GENSTUDY_JETCHARGE/JetMassTrim$
...
# BEGIN PLOT /MC_GENSTUDY_JETCHARGE/JetMassPrune$
Title= Pruned Jet Mass
XLabel=$GeV/c^2$
YLabel=$\int f(x) dx \equiv 1$ 
LogY=0
LegendYPos=0.95
...
# BEGIN PLOT /MC_GENSTUDY_JETCHARGE/NSubJettiness$
...
# BEGIN PLOT /MC_GENSTUDY_JETCHARGE/NSubJettiness1Iter$
Title= N-subjettiness 1 Iteration
XLabel=FIXME ($n$)
YLabel=$\int f(x) dx \equiv 1$ 
LogY=0
LegendYPos=0.95
...
# BEGIN PLOT /MC_GENSTUDY_JETCHARGE/NSubJettiness2Iter$
Title= N-subjettiness 2 Iteration
XLabel=FIXME ($n$)
YLabel=$\int f(x) dx \equiv 1$ 
LogY=0
LegendYPos=0.95
